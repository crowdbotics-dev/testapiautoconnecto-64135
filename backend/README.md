...
## Project Structure
    ...
    ├── testapiautoconnecto_64135  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_64135`
...
2. Clone this repo and `cd testapiautoconnecto_64135`
